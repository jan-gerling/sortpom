...
public class SingleNewlineInTextWrapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sortpom.wrapper.content.SingleNewlineInTextWrapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SingleNewlineInTextWrapper_ESTest_scaffolding.class.getClassLoader() ,
      "org.jdom.Parent",
      "org.jdom.Document",
      "org.jdom.Comment",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SingleNewlineInTextWrapper_ESTest_scaffolding.class.getClassLoader()); 
