...
public class FileUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sortpom.util.FileUtil"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("sortpom.parameter.PluginParameters", false, FileUtil_ESTest_scaffolding.class.getClassLoader()));
  }
